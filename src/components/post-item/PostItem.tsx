...
import { PostItemProps } from "@/app/post-list/page"

export const PostItem = ({ name, appealPoint, imageUrl, price, likes: initialLikes }: PostItemProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <p className="text-xl font-bold text-emerald-600">¥{price.toLocaleString()}</p>
        <Button
          variant="ghost"
          size="sm"
          onClick={handleLike}
        ...
        >
          <Heart className={`h-5 w-5 ${likes > 0 ? 'fill-red-500 text-red-500' : ''}`} />
